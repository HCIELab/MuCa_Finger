...
void setup () {
 ...
 // destImg = createImage(skinImage.width * resizeFactor * (skinImage.width / PHYSICAL_W),
 //                       skinImage.height  * resizeFactor * (skinImage.height / PHYSICAL_H), RGB);
}
